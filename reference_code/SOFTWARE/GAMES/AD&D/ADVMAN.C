/* ADVMAN.C: Adventure character manual designer
...
void main(void)
{
	...
	{
		clrscr();
		cprintf("Do you wish to:\n\r");
		cprintf("1 - View character\n\r");
		cprintf("2 - Create character\n\r");
		choice = getche();
