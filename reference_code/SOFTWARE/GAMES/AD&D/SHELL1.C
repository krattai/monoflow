/* SHELL1.C: Adventure game shell 1
...
void main(void)
{
	...
	char y = 'n',
		...
		form2[] = "1,1,Do you wish to:,"
				  "1,2,1 - Examine characters,"
				  "1,3,2 - Load previous game,"
				  "1,4,3 - Start new game,"
				  "1,5,4 - Quit";
	struct ffblk file;
	...
	while(choice != '4')
	{
		...
		switch(choice)
		{
			case '1':	system("REN MKCHR1.FIL,MKCHR1.EXE");
						spawnl(P_WAIT,"MKCHR1",NULL,NULL);
						system("REN MKCHR1.EXE,MKCHR1.FIL");
						CLS;
						break;
			case '2':	cprintf("Not working yet");
						break;
			case '3':	cprintf("Not working yet");
						break;
			case '4':	CLS;
						cprintf("See ya!");
						getch();
...
void create(void)
{
	...
	Put_window(61,2,80,10,WHITE,BLUE);
	CLS;
	Show_form(form3);

	Put_window(1,11,80,24,YELLOW,BLUE);
	CLS;
	...
	Put_window(1,2,60,10,WHITE,BLUE);
	CLS;
	Show_form(form4);
	...
	Put_window(61,2,80,11,YELLOW,BLUE);
	CLS;
	Put_window(1,11,80,24,YELLOW,BLUE);
	change = 1;
